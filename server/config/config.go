...
func initViper() (Constants, error) {
	...
	if os.Getenv("ENVIRONMENT") == "DOCKER" {
		viper.SetConfigName("Mntop_docker.config") // Configuration fileName without the .TOML or .YAML extension
	} else {
		viper.SetConfigName("Mntop.config") // Configuration fileName without the .TOML or .YAML extension
	}
